...
public class Prova3App {

    private static final Logger log = LoggerFactory.getLogger(Prova3App.class);

    private final Environment env;

    public Prova3App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Prova3App.class);
